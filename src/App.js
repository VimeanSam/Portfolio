...
import resume from "./Files/VimeanSamResume2025.pdf";
...
class App extends Component {
  ...
  render() {
    const list = projectLists.map(
      (data, index) =>
        index >= this.state.start &&
        index <= this.state.stop && (
          <Fade key={index}>
              ...
              <div className="row no-gutters">
                <div className="col-md-4">
                  <img
                    ...
                    id={data.title}
                    onClick={this.showSlides}
                    src={require(`./projectPics/${data.mainpic}.jpg`)}
                    alt=""
                  />
                </div>
                  ...
                  <div className="card-body">
                    {data.link === "" ? (
                      ...
                      <h4>
                        ...
                        <a
                          className="linkIcon"
                          style={{ color: `rgb(${this.state.variant})` }}
                          target="_blank"
                          href={data.link}
                          rel="noopener noreferrer"
                        >
      ...
      <React.Fragment>
          ...
          <div className="row">
            <div className="column">
              <div className="cardTab">
                ...
                <Zoom>
                  ...
                  <p style={{ fontSize: "19px" }}>
                    <span style={{ color: `rgb(${this.state.variant})` }}>
                      <FaHome />
                    </span>{" "}
                  ...
                  <p style={{ fontSize: "19px" }}>
                    Greetings, my name is Vimean Sam. I am a software engineer
                    with a keen interest in full-stack web development. I am a
                    highly motivated and creative individual who is successful
            ...
            <div className="column-3">
              <div className="cardTab">
                <Zoom>
                  ...
                  <div style={{ padding: "15px" }}>
                    ...
                    <h5 style={{ color: `rgb(${this.state.variant})` }}>
                      <span>
                        <FaCalendarAlt />
                      </span>{" "}
                      May 2022 - Present
                    ...
                    <ul className="bullet-point">
                      <li>
                        Co-found and developed a cross-platform educational
                        mobile application that encourages users to join
                        learning communities to interact with like-minded
                        individuals. Main features include live streaming, Q/A
                        posting, articles, video uploading, and real-time
                        messaging. The app is available on Apple Store and
                        Google Play.
                      </li>
                      <li>
                        ...
                        for notifications which allows users to communicate with
                        one another within the application.
                      </li>
                      <li>
                        Designed and developed various{" "}
                        <b style={{ color: `rgb(${this.state.variant})` }}>
                          RESTFUL API
                        </b>{" "}
                        endpoints using{" "}
                    ...
                    <h5>Full-Stack Software Engineer (Remote)</h5>
                    <h5 style={{ color: `rgb(${this.state.variant})` }}>
                      <span>
                        <FaCalendarAlt />
                      </span>{" "}
                    ...
                    <ul className="bullet-point">
                      ...
                      <li>
                        ...
                        (Model-View-Controller) software design for various
                        server-side operations using{" "}
                        <b style={{ color: `rgb(${this.state.variant})` }}>
                          Node.js
                        </b>
                        ,{" "}
                        ...
                        resulting in code reusability and improved maintenance
                      ...
                      <li>
                        Traverse across all levels of code stack and produce
                    ...
                    <ul className="bullet-point">
                      <li>
                        ...
                        to implement API flows that connect different web
                        services (
                        <b style={{ color: `rgb(${this.state.variant})` }}>
                          REST
                        </b>
                        ...
                        ) with various systems and databases (mainly{" "}
                        <b style={{ color: `rgb(${this.state.variant})` }}>
                          MySQL
                        </b>
                        ).
                      ...
                      <li>
                        ...
                        to transform API data into various content types such as{" "}
                        <b style={{ color: `rgb(${this.state.variant})` }}>
                          JSON
                        </b>{" "}
                        and{" "}
                      ...
                      <li>
                        ...
                        Platform to create, connect, and modify data using
                        Salesforce language of{" "}
                        <b style={{ color: `rgb(${this.state.variant})` }}>
                          Apex Code
                        </b>
                        ,{" "}
              ...
              <div className="cardTab">
                <Zoom>
                  ...
                  <div style={{ padding: "15px" }}>
                    ...
                    <p style={{ fontSize: "19px" }}>
                      <b>Relavant coursework: </b> Data Structures, Software
                      Development in Java, Software Engineering, Database
                      Systems, Internet Applications Design and Development.{" "}
                    </p>
                  </div>
                </Zoom>
              </div>
              ...
              <div className="cardTab">
                ...
                <p style={{ fontSize: "19px" }}>
                  The GitHub repo of the project is accessible by clicking the
                  title.
                  <b> The globe icon </b> contains a link to the live demo of
                  the project.
                </p>
                {list}
                <div className="control">
                  {this.state.page - 1 > 0 ? (
                    <span
                      ...
                      style={{
                        textDecoration: "none",
                        backgroundColor: `rgb(${this.state.variant})`,
                      }}
                  ...
                  <span style={{ fontSize: "19px", padding: "0 1em" }}>
                    {" "}
                    Page <b>{this.state.page}</b> of{" "}
                    {Math.ceil(projectLists.length / 3)}{" "}
                  </span>
        ...
        {this.state.open && (
          <Lightbox
            ...
            prevSrc={
              slideshow[
                (this.state.photoIndex + slideshow.length - 1) %
                  slideshow.length
              ]
            }
        ...
        <footer>
          <br></br>
          <p style={{ fontSize: "19px" }}>
            Simple static portfolio website created by Vimean Sam using React.js
            and powered by Netlify
          </p>
        </footer>
      </React.Fragment>
    );
